...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || 'f15157e68b11406392b508d2406f6d37',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大晋的BLOG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Insurance Broker', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.peijincn.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JIN,博客,分享,保险', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'qddxpj@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-85F6MVQPSF', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '大晋的BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
      process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '保险知识分享', // 站点描述，被notion中的页面描述覆盖
